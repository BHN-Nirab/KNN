...
public class main {
    ...
    public static void readDataset()
    {
        Scanner sc = null;
        try {
            sc = new Scanner(new File("src/main/res/iris.data"));
    ...
    {
        System.out.print("Enter Iris value (i.e>5.1,3.5,1.4,0.2,Iris-setosa): ");
    ...
    {
        return (itemCount*100)/totalItem;
    }
    ...
    public static void printType()
    {
        ...
        for(int i=0; i<typesArray.length; i++)
        {
            ...
            System.out.println(typesArray[i] + " = " + percentage + "%");
        }
    }
